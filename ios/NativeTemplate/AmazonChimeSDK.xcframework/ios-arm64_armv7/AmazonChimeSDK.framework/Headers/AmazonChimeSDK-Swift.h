...
@property (nonatomic, readonly, strong) IngestionMetadata * _Nonnull metadata;
...
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type metadata:(IngestionMetadata * _Nonnull)metadata payloads:(NSArray<IngestionPayload *> * _Nonnull)payloads;
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type metadata:(IngestionMetadata * _Nonnull)metadata payloads:(NSArray<IngestionPayload *> * _Nonnull)payloads version:(NSInteger)version OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC14AmazonChimeSDK17IngestionMetadata")
@interface IngestionMetadata : NSObject
...
@property (nonatomic, readonly, copy) NSString * _Nullable mediaSdkVersion;
...
@property (nonatomic, readonly, copy) NSString * _Nullable meetingId;
...
- (nonnull instancetype)initWithMetadata:(IngestionMetadata * _Nonnull)metadata events:(NSArray<IngestionEvent *> * _Nonnull)events OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithExternalMeetingId:(NSString * _Nullable)externalMeetingId mediaPlacement:(MediaPlacement * _Nonnull)mediaPlacement mediaRegion:(NSString * _Nonnull)mediaRegion meetingId:(NSString * _Nonnull)meetingId OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithMeetingId:(NSString * _Nonnull)meetingId externalMeetingId:(NSString * _Nullable)externalMeetingId credentials:(MeetingSessionCredentials * _Nonnull)credentials urls:(MeetingSessionURLs * _Nonnull)urls urlRewriter:(NSString * _Nonnull (^ _Nonnull)(NSString * _Nonnull))urlRewriter OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithItems:(NSArray<TranscriptItem *> * _Nonnull)items transcript:(NSString * _Nonnull)transcript OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithType:(enum TranscriptItemType)type startTimeMs:(int64_t)startTimeMs endTimeMs:(int64_t)endTimeMs attendee:(AttendeeInfo * _Nonnull)attendee content:(NSString * _Nonnull)content vocabularyFilterMatch:(BOOL)vocabularyFilterMatch OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithResultId:(NSString * _Nonnull)resultId channelId:(NSString * _Nullable)channelId isPartial:(BOOL)isPartial startTimeMs:(int64_t)startTimeMs endTimeMs:(int64_t)endTimeMs alternatives:(NSArray<TranscriptAlternative *> * _Nonnull)alternatives OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// \param avFormat format from the <code>AVCaptureDevice</code>
///
